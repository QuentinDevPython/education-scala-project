...
def main: Unit =
  ...
  def sudoku(): Unit =
    var difficulty = ask_difficulty()
    lauch_chosen_sudoku(difficulty)
  

  def ask_difficulty(): String =
  ...
  def lauch_chosen_sudoku(difficulty: String): Unit =
    ...
    if (difficulty == "F") {
      ...
      println("Je n'ai pas compris votre choix.")
      var difficulty: String = ask_difficulty()
    }
