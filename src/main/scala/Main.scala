...
def main: Unit =
  ...
  def sudoku(): Unit =
    var difficulty = ask_difficulty_sudoku()
    launch_chosen_sudoku(difficulty)


  def map_coloring(): Unit =
    var difficulty = ask_difficulty_coloring()
  ...
  def launch_chosen_sudoku(difficulty: String): Unit =
    ...
    if (difficulty == "F") {
      ...
      println("Je n'ai pas compris votre choix.")
      var difficulty: String = ask_difficulty_sudoku()
    }
  ...
  def launch_chosen_map(difficulty: String): Unit =
    ...
    if (difficulty == "AS") {
      ...
      println("Je n'ai pas compris votre choix.")
      var difficulty: String = ask_difficulty_coloring()
    }
